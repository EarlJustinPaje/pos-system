        ...
        <div class="card-body">
            <form action="{{ route('promotions.update', $promotion) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $promotion->code) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror">{{ old('description', $promotion->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="promotion_type" id="promotion_type" class="form-control @error('promotion_type') is-invalid @enderror" required>
                                ...
                                <option value="percentage_discount" {{ old('promotion_type', $promotion->promotion_type) == 'percentage_discount' ? 'selected' : '' }}>Percentage Discount (%)</option>
                                <option value="fixed_amount_discount" {{ old('promotion_type', $promotion->promotion_type) == 'fixed_amount_discount' ? 'selected' : '' }}>Fixed Amount Discount (₱)</option>
                                <option value="buy_x_get_y" {{ old('promotion_type', $promotion->promotion_type) == 'buy_x_get_y' ? 'selected' : '' }}>Buy X Get Y Free</option>
                            </select>
                ...
                <div class="form-group">
                    ...
                    <select name="branch_id" id="branch_id" class="form-control @error('branch_id') is-invalid @enderror">
                        ...
                        @foreach($branches as $branch)
                            <option value="{{ $branch->id }}" {{ old('branch_id', $promotion->branch_id) == $branch->id ? 'selected' : '' }}>{{ $branch->name }}</option>
                        @endforeach
                    </select>
                    @error('branch_id')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="min_purchase_amount" id="min_purchase_amount" class="form-control @error('min_purchase_amount') is-invalid @enderror" value="{{ old('min_purchase_amount', $promotion->min_purchase_amount) }}" step="0.01" min="0">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="max_uses" id="max_uses" class="form-control @error('max_uses') is-invalid @enderror" value="{{ old('max_uses', $promotion->max_uses) }}" min="0">
                            @error('max_uses')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
